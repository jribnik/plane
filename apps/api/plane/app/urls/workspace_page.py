...
# Global (workspace-wide) wiki pages. Deliberately namespaced under
# `wiki/` rather than `pages/` to avoid colliding with any future upstream EE
# workspace-pages feature under the same workspace prefix.
urlpatterns = [
    path(
        "workspaces/<str:slug>/wiki/pages-summary/",
    ...
    # favorite pages
    path(
        "workspaces/<str:slug>/wiki/favorite-pages/<uuid:page_id>/",
